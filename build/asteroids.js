...
/***/ function(module, exports, __webpack_require__) {
	...
	var highscores_1 = __webpack_require__(22);
	var highScoreMode_1 = __webpack_require__(23);
	var initialsMode_1 = __webpack_require__(24);
	var attractMode_1 = __webpack_require__(25);
	var gameMode_1 = __webpack_require__(28);
	var ATTRACT_TIME = 15;
	var Modes;
	(function (Modes) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var flash_1 = __webpack_require__(19);
	var rocks_1 = __webpack_require__(20);
	var scoreMarker_1 = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Draw = (function () {
	    ...
	    Draw.prototype.scorePlayer1 = function (score) {
	        ...
	        while (text.length < 2)
	            text = '0' + text;
	        this.text(text, X_START - 2, Y_START - 2, screen_1.default.font.medium, magenta(.5));
	        this.text(text, X_START - 1, Y_START - 1, screen_1.default.font.medium, cyan(.5));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScoreMarker = (function (_super) {
	    ...
	    ScoreMarker.prototype.draw = function () {
	        screen_1.default.draw.text(this.text, this.origin.x - 2, this.origin.y - 2, this.life * 50, draw_1.magenta(this.life));
	        screen_1.default.draw.text(this.text, this.origin.x - 1, this.origin.y - 1, this.life * 50, draw_1.cyan(this.life));
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var screen_1 = __webpack_require__(6);
	var collisions_1 = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var screen_1 = __webpack_require__(6);
	var sounds_1 = __webpack_require__(13);
	var thump_1 = __webpack_require__(29);
	var GameMode = (function (_super) {
	    ...
	    GameMode.prototype.renderStatic = function () {
	        ...
	        if (this.world.ship) {
	            ...
	            screen_1.default.draw.line(40, 80, 40 + this.world.ship.shield * 50, 80, "rgba(255,255,255,.6)");
	        }
	        if (!this.world.started) {
	    ...
	    GameMode.prototype.checkCollisions = function (dt) {
	        ...
	        collisions.check([ship], [powerup], function (ship, powerup) {
