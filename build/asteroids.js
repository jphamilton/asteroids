...
var draw_1 = __webpack_require__(11);
var Screen = (function () {
    function Screen() {
        var _this = this;
        this.x = 0;
...
var lut_1 = __webpack_require__(26);
...
Object.defineProperty(exports, "__esModule", { value: true });
var screen_1 = __webpack_require__(0);
var quadtree_1 = __webpack_require__(27);
var lineclip_1 = __webpack_require__(25);
...
Object.defineProperty(exports, "__esModule", { value: true });
var screen_1 = __webpack_require__(0);
var ship_1 = __webpack_require__(12);
...
var Ship = (function (_super) {
    ...
    Ship.prototype.render = function () {
        this.draw();
        if (this.moving && util_1.random(1, 10) % 2 === 0) {
            this.flame.draw(false);
        }
        if (this.trails.length) {
            this.trails.forEach(function (trail) {
                if (trail.alpha > 0) {
                    screen_1.default.draw.shape(trail.points, trail.x, trail.y, "rgba(255,0,255," + trail.alpha + ")", true);
                    screen_1.default.draw.shape(trail.points, trail.x - 1, trail.y - 1, "rgba(0,255,255," + trail.alpha + ")", true);
                    trail.alpha -= .1;
                }
            });
        }
    ...
    Ship.prototype.update = function (dt) {
        ...
        this.rotating = keys_1.Key.isDown(keys_1.Key.ROTATE_LEFT) || keys_1.Key.isDown(keys_1.Key.ROTATE_RIGHT);
...
var shockwave_1 = __webpack_require__(30);
var flash_1 = __webpack_require__(24);
var rocks_1 = __webpack_require__(28);
var scoreMarker_1 = __webpack_require__(29);
var vector_1 = __webpack_require__(3);
var util_1 = __webpack_require__(1);
var screen_1 = __webpack_require__(0);
var sounds_1 = __webpack_require__(4);
...
var World = (function () {
    ...
    World.prototype.addRocks = function () {
        ...
        for (var i = 0; i < count; i++) {
            ...
            var v = vector_1.Vector.fromAngle(util_1.random(1, 360));
            var x = void 0;
            var y = void 0;
            switch (zone) {
                case 1:
...
var attractMode_1 = __webpack_require__(13);
var gameMode_1 = __webpack_require__(14);
var global_1 = __webpack_require__(6);
var ATTRACT_TIME = 15;
var Modes;
(function (Modes) {
...
var Explosion = (function (_super) {
    ...
    function Explosion(x, y, size) {
        ...
        _this.points = [];
        for (var i = 0; i < 15; i++) {
            var v = vector_1.Vector.fromAngle(util_1.random(1, 360), Math.random() * VELOCITY);
