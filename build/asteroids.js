...
var lineclip_1 = __webpack_require__(24);
...
var GameMode = (function (_super) {
    ...
    GameMode.prototype.renderDebug = function () {
        ...
        if (this.world.ship) {
            ...
            screen_1.default.draw.text(this.world.ship.vx.toString(), this.world.ship.origin.x + 20, this.world.ship.origin.y + 40, 10);
            screen_1.default.draw.text(this.world.ship.vy.toString(), this.world.ship.origin.x + 20, this.world.ship.origin.y + 60, 10);
        }
...
var explosion_1 = __webpack_require__(22);
var shockwave_1 = __webpack_require__(29);
