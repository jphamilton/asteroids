...
/***/ function(module, exports, __webpack_require__) {
	...
	var World = (function () {
	    ...
	    World.prototype.createExplosion = function (x, y, size, multiplier) {
	        var _this = this;
	        if (size === void 0) { size = 100; }
	        if (multiplier === void 0) { multiplier = 1; }
	        var explosion = new explosion_1.Explosion(x, y, size);
	        var shockwave = new shockwave_1.Shockwave(x, y, size, multiplier);
	    ...
	    World.prototype.rockDestroyed = function (rock, multiplier) {
	        if (multiplier === void 0) { multiplier = 1; }
	        var boom = this.createExplosion(rock.origin.x, rock.origin.y, rock.size * 5, multiplier);
	    ...
	    World.prototype.updateAlienTimer = function (dt) {
	        ...
	        if (!this.alien) {
	            ...
	            if (this.alienTimer <= 0) {
	                this.addAlien();
	                this.alienTimer = util_1.random(10 - level, 15);
	            }
	        }
	    };
