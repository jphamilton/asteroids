...
/***/ function(module, exports, __webpack_require__) {
	...
	var sounds_1 = __webpack_require__(14);
	var highscores_1 = __webpack_require__(23);
	var highScoreMode_1 = __webpack_require__(24);
	var initialsMode_1 = __webpack_require__(25);
	var attractMode_1 = __webpack_require__(26);
	var gameMode_1 = __webpack_require__(30);
	...
	var Asteroids = (function () {
	    ...
	    Asteroids.prototype.update = function (dt) {
	        ...
	        if (keys_1.Key.isPressed(keys_1.Key.MONITOR_BURN)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var alien_1 = __webpack_require__(17);
	var explosion_1 = __webpack_require__(18);
	var shockwave_1 = __webpack_require__(19);
	var flash_1 = __webpack_require__(20);
	var rocks_1 = __webpack_require__(21);
	var scoreMarker_1 = __webpack_require__(22);
	...
	var World = (function () {
	    ...
	    Object.defineProperty(World.prototype, "objects", {
	        get: function () {
	            return [this.ship, this.alien, this.powerup].concat(this.shipBullets, this.alienBullets, this.rocks, this.shockwaves, this.scenery);
	        },
	        enumerable: true,
	        configurable: true
	    });
	...
	var Ship = (function (_super) {
	    ...
	    Ship.prototype.fire = function () {
	        ...
	        if (this.bulletTimer <= 0 && this.bulletCount < MAX_BULLETS) {
	            ...
	            var kbv = new vector_1.Vector(kba, 5);
	            this.origin.x += kbv.x;
	            this.origin.y += kbv.y;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Object2D = (function (_super) {
	    ...
	    Object2D.prototype.draw = function (closed) {
	        if (closed === void 0) { closed = true; }
	        screen_1.default.draw.shape(this.points, this.origin.x, this.origin.y, 'rgba(255,255,255,.8)', closed);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var howler_1 = __webpack_require__(15);
	var VOLUME = .5;
	var soundOn = true;
	exports.all = [];
	    ...
	    Explosion.prototype.render = function (dt) {
	        this.points.forEach(function (p) {
	            if (util_1.random(1, 10) % 2 === 0) {
	                screen_1.default.draw.rect(p.x, p.y, 2, 2, "rgba(255,255,255," + p.alpha + ")");
	            }
	        });
	    };
	    return Explosion;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScoreMarker = (function (_super) {
	    ...
	    ScoreMarker.prototype.draw = function () {
	        screen_1.default.draw.text(this.text, this.origin.x, this.origin.y, this.life * 50, draw_1.white(this.life));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var screen_1 = __webpack_require__(6);
	var collisions_1 = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var screen_1 = __webpack_require__(6);
	var quadtree_1 = __webpack_require__(28);
	var lineclip_1 = __webpack_require__(29);
	        ...
	        var _loop_1 = function (i) {
	            ...
	            candidates.forEach(function (candidate) {
	                ...
	                if (i < bullets.length - 1) {
	                    ...
	                    results.length = 0;
	                    lineclip_1.lineclip([[bullet1.origin.x, bullet1.origin.y], [bullet2.origin.x, bullet2.origin.y]], bbox, results);
	                    if (results.length) {
	                        if (dcb) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var collisions_1 = __webpack_require__(27);
	var screen_1 = __webpack_require__(6);
	var thump_1 = __webpack_require__(31);
	var global_1 = __webpack_require__(8);
	var GameMode = (function (_super) {
	    ...
	    GameMode.prototype.renderStatic = function () {
	        ...
	        if (this.world.ship) {
	            screen_1.default.draw.line(40, 80, 140, 80, "rgba(255,255,255,.4)");
	            screen_1.default.draw.line(40, 80, 40 + this.world.ship.shield * 100, 80, "rgba(255,255,255,.6)");
	        }
	        if (!this.world.started) {
	    ...
	    GameMode.prototype.renderDebug = function () {
	        ...
	        this.lines.forEach(function (l) {
	            screen_1.default.draw.line(l[0].origin.x, l[0].origin.y, l[1].origin.x, l[1].origin.y, '#fd1f00');
	        });
